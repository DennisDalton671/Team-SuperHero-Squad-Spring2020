...
<<<<<<< HEAD
	...
	public Item(String id, String itemName, String description, String acquired, String acquired2, String itemBoost,
			String itemBenefit, String itemUse, String craft) {
		this.id = id;
